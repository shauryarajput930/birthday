...
export default function MessageScreen({ onNext }) {
    ...
    const fullMessage = `Happy Birthday, Cutiepie! You deserve all the happiness, love, and smiles in the world today and always.
    ...
    return (
        <div className="px-4 md:px-6 py-10 text-center">
            ...
            <div className="mx-auto relative w-full max-w-3xl flex justify-center">
                ...
                >
                    <p className="text-[#301733] text-base md:text-lg leading-relaxed overflow-y-auto max-h-[400px] pr-2 whitespace-pre-wrap">
                        {displayedText}
